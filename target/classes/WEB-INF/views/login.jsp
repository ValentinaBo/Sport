...
<body onload='document.loginForm.username.focus();'>
  ...
  <div class="container" align="center">
	...
	<h1>Entra nella Società Sportiva</h1>

	<div id="login-box">

		<h2>Login con Username e Password</h2>
	...
	<h6>
		Non hai mai effettuato l'accesso? Clicca 
		<a href="nuovoCliente" class="reglink">qui</a> per registrarti
	</h6>
  </div>
</body>
</html>